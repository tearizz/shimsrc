...
EFI_GUID EFI_TCP_BINDING_GUID = { 0x00720665, 0x67EB, 0x4A99, { 0xBA, 0xF7, 0xD3, 0xC3, 0x2E, 0x2C, 0x12, 0x43 } };
EFI_GUID EFI_TCP_FILE_GUID = { 0x1A7E4468, 0x2F55, 0x4A56, { 0x90, 0x3C, 0x01, 0x26, 0x5E, 0xB7, 0x62, 0x2B } };
EFI_GUID EFI_HTTP_FILE_GUID = { 0xA6146931, 0xD233, 0x4340, { 0x9B, 0x2, 0x94, 0x65, 0xB, 0xAE, 0x75, 0x75 } };
EFI_GUID EFI_FIRMWARE_VOLUME_GUID = { 0x220e73b6, 0x6bdb, 0x4413, { 0x84, 0x5, 0xb9, 0x74, 0xb1, 0x8, 0x61, 0x90 } };
